...
export default async function LeadsPage({ searchParams }: Props) {
  ...
  let query = supabase
    .from('leads')
    .select('id, name, mobile, email, address, address_line_2, city, postcode, stage, pipeline, is_hot, lead_source, updated_at, created_at, first_contact_at, assigned_to, marketing_consent, distance_miles, sms_sent_at, brochures_sent, approx_size_sqm, tags, tasks(id, title, due_date, completed_at)', { count: 'exact' })
